package com.yumiao.usdttransfer.interceptor;


import com.yumiao.usdttransfer.utils.RequestUtil;
...
public class LogInterceptor extends HandlerInterceptorAdapter {
    ...
    public void afterCompletion(HttpServletRequest request,
        ...
        if (uri.contains("swagger") || uri.contains("configuration") || uri.contains("v2")  || request.getRequestURI().indexOf("error")>-1){
            return;
        }
